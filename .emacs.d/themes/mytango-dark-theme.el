;;; mytango-dark-theme.el --- Tango-based custom theme for faces
...
;; Modified by: Jonas Hörsch <coroa@online.de>
...
(provide-theme 'mytango-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; mytango-dark-theme.el ends here
